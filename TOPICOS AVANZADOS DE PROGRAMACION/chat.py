...
def main(page: ft.Page):
    ...
    def join_chat_click(e):
        if not join_user_name.value:
            join_user_name.error_text = "¡El nombre no puede estar en blanco!"
            join_user_name.update()
        else:
            page.session.store.set("nombre_usuario", join_user_name.value)
            ...
            page.pubsub.send_all(
                Message(
                    ...
                    message_type="mensaje_inicio de sesión",
                )
            )
    ...
    async def send_message_click(e):
        if new_message.value != "":
            page.pubsub.send_all(
                Message(
                    page.session.store.get("nombre_usuario"),
                    new_message.value,
    ...
    def on_message(message: Message):
        ...
        elif message.message_type == "mensaje_inicio de sesión":
    ...
    welcome_dlg = ft.AlertDialog(
        ...
        actions=[ft.Button(content="Unirse al chat", on_click=join_chat_click)],
